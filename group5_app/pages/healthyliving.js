...
export default function Home() {
  return <PageLayoutContainer>
    ...
    <div className="text">
      <TextComponent Subtitle="What is the goal of your diet plan?" Hint="By choosing your main goal, we’ll be able to help you create a suitable plan for you" h3fontsize="24px" pfontsize="18px"/>
      </div>
    <div className="btn">
