...
export default function Home() {
  return <PageLayoutContainer>
    ...
    <div className="text">
      <TextComponent Subtitle="Negative effects of fastfood" Hint="By choosing one of them, you can learn more knowledge about effects of fastfood"  pfontsize="16px"/>
      </div>
    <div className="btn">
