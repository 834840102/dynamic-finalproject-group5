...
export default function Home() {
  ...
  <PageLayoutContainer>
    <div className="text">
      ...
      <TextComponent Subtitle="" Hint="Maintaining a healthy weight is important to overall health. We recommend you should maintain your weight at normal BMI level, to avoid the risk of facing many diseases affecting your health. " pfontsize="18px" pfontweight="400" />
    </div>
